...
do
    ...
    function library:Loader(info)
        ...
        function window:CloseContent()
            if window.currentContent.dropdown and window.currentContent.dropdown.open then
                ...
                utility:LoadImage(dropdown.dropdown_image, "arrow_down", "https://imgur.com/xM29aN2")
                --
            ...
            elseif window.currentContent.multibox and window.currentContent.multibox.open then
                ...
                utility:LoadImage(multibox.multibox_image, "arrow_down", "https://imgur.com/xM29aN2")
                --
    ...
    function pages:PlayerList(info)
        ...
        for Index = 1, 1 do
            ...
            --
            utility:LoadImage(button_image, "arrow_down", "https://imgur.com/xM29aN2")
            --
            ...
            --
            utility:LoadImage(button_gradient, "gradient", "https://imgur.com/a/94ATeAX")
            --
            library.began[#library.began + 1] = function(Input)
        ...
        --
        utility:LoadImage(list_gradient, "gradient", "https://imgur.com/a/94ATeAX")
        --
    ...
    function sections:Toggle(info)
        ...
        --
        utility:LoadImage(toggle__gradient, "gradient", "https://imgur.com/a/94ATeAX")
        --
        function toggle:Get()
        ...
        function toggle:Colorpicker(info)
            ...
            utility:LoadImage(colorpicker__gradient, "gradient", "https://imgur.com/a/94ATeAX")
            --
        ...
        function toggle:Keybind(info)
            ...
            --
            utility:LoadImage(keybind__gradient, "gradient", "https://imgur.com/a/94ATeAX")
            --
    ...
    function sections:Slider(info)
        ...
        --
        utility:LoadImage(slider__gradient, "gradient", "https://imgur.com/a/94ATeAX")
        --
    ...
    function sections:Button(info)
        ...
        --
        utility:LoadImage(button_gradient, "gradient", "https://i.imgur.com/a/94ATeAX")
        --
        library.began[#library.began + 1] = function(Input)
    ...
    function sections:TextBox(info)
        ...
        --
        utility:LoadImage(textbox_gradient, "gradient", "https://i.imgur.com/a/94ATeAX")
        --
    ...
    function sections:Dropdown(info)
        ...
        --
        utility:LoadImage(dropdown_image, "arrow_down", "https://i.imgur.com/xM29aN2")
        utility:LoadImage(dropdown__gradient, "gradient", "https://i.imgur.com/a/94ATeAX")
        --
        if max then
    ...
    function sections:Multibox(info)
        ...
        --
        utility:LoadImage(multibox_image, "arrow_down", "https://i.imgur.com/xM29aN2")
        utility:LoadImage(multibox__gradient, "gradient", "https://i.imgur.com/a/94ATeAX")
        --
                ...
                elseif utility:MouseOverDrawing({section.section_frame.Position.X, section.section_frame.Position.Y + multibox.axis, section.section_frame.Position.X + section.section_frame.Size.X, section.section_frame.Position.Y + multibox.axis + (name and 15 or 0) + 20}) and not window:IsOverContent() then
                    ...
                    if not multibox.open then
                        ...
                        for i,v in pairs(multibox.options) do
                            ...
                            --
                            utility:LoadImage(multibox_value_gradient, "gradient", "https://i.imgur.com/a/94ATeAX")]]
                            --
